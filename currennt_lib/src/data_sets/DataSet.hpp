...
namespace data_sets {
    ...
    private:
        ...
        std::shared_ptr<DataSetFraction> _makeFractionTask(int firstSeqIdx);
        std::shared_ptr<DataSetFraction> _makeFirstFractionTask();
    ...
    private:
        ...
        Cpu::real_vector m_outputWeights;
        ...
        std::unique_ptr<thread_data_t> m_threadData; // just because nvcc hates boost headers // so do I
        std::vector<int> m_fracFirstSeqIdx;
        int m_curFracIdx;

        std::vector<Cpu::real_vector> m_inputs;
        std::vector<Cpu::int_vector>  m_outputsClas;
        std::vector<Cpu::real_vector> m_outputsRegr;
        std::mt19937 rg;
    ...
    public:
         ...
         * @param cachePath If given, use this path for the temp folder
         */
        DataSet(const std::vector<std::string> &ncfiles, int parSeq, real_t fraction=1, 
            ...
            bool balanceData=false, std::string cachePath = "");
         ...
         */
        std::shared_ptr<DataSetFraction> getNextFraction();
        ...
        /**
         * Returns the output weights
         *
         * @return vector of output weights
         */
        Cpu::real_vector outputWeights() const;
