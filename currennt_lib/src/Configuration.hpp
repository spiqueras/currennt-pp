...
private:
    ...
    unsigned m_epochsLRUpdate;

    real_t m_learningRate;
    real_t m_momentum;
    real_t m_learningRateDecay;
    real_t m_minLearningRate;
    real_t m_weight_decay;
    real_t m_adam_beta1;
    real_t m_adam_beta2;
    real_t m_adam_epsilon;
    ...
    std::string m_feedForwardSubtype;
...
public:
    ...
    /**
     * Returns the weights decay
     *
     * @return The weights decay
     */
    real_t weight_decay() const;
     ...
     * @return Adam epsilon
     */
    real_t adam_epsilon() const;

    /**

     * If true, use Nesterov's Accelerated Gradient (NAG)
     *
     * @return If true, use Nesterov's Accelerated Gradient (NAG)
     */
    bool nesterovMomentum() const;

    /**

     * If true, use Nesterov's Accelerated Gradient (NAG) TODO
     *
     * @return If true, use Nesterov's Accelerated Gradient (NAG)
     */
    int epochsLRUpdate() const;
     ...
     * @return If true, use Nesterov's Accelerated Gradient (NAG)
     */
    real_t learningRateDecay() const;
     ...
     * @return If true, use Nesterov's Accelerated Gradient (NAG)
     */
    real_t minLearningRate() const;

    /**

     * If true, balance data sets so sets with less samples are oversampled
     *
     * @return If true, balance data sets so sets with less samples are oversampled
     */
    bool balanceData() const;
    ...
    /**
     * Returns the forward pass subtype if defined by the config file
     *
     * @return The forward pass subtype if defined by the config file
     */
    const std::string& feedForwardSubtype() const;
