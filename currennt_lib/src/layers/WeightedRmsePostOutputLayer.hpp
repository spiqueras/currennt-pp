...
#ifndef LAYERS_WEIGHTEDRMSEPOSTOUTPUTLAYER_HPP
#define LAYERS_WEIGHTEDRMSEPOSTOUTPUTLAYER_HPP
...
namespace layers {
    ...
    class WeightedRmsePostOutputLayer : public PostOutputLayer<TDevice>
    {
    ...
    public:
         ...
         * Destructs the Layer
         */
        virtual ~WeightedRmsePostOutputLayer();
...
#endif // LAYERS_WEIGHTEDRMSEPOSTOUTPUTLAYER_HPP
