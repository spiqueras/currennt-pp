...
#ifndef LAYERS_AbsPOSTOUTPUTLAYER_HPP
#define LAYERS_AbsPOSTOUTPUTLAYER_HPP
...
namespace layers {
    ...
    class AbsPostOutputLayer : public PostOutputLayer<TDevice>
    {
    public:
        /**
...
#endif // LAYERS_AbsPOSTOUTPUTLAYER_HPP
