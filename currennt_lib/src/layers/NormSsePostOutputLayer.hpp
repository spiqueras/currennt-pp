...
#ifndef LAYERS_NORMSSEPOSTOUTPUTLAYER_HPP
#define LAYERS_NORMSSEPOSTOUTPUTLAYER_HPP
...
namespace layers {
    ...
    class NormSsePostOutputLayer : public PostOutputLayer<TDevice>
    {
    public:
        /**
         ...
         * Destructs the Layer
         */
        virtual ~NormSsePostOutputLayer();
...
#endif // LAYERS_NORMSSEPOSTOUTPUTLAYER_HPP
