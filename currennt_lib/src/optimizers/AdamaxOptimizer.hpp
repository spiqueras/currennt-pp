...
#ifndef OPTIMIZERS_AdamaxOPTIMIZER_HPP
#define OPTIMIZERS_AdamaxOPTIMIZER_HPP
...
namespace optimizers {
    ...
    class AdamaxOptimizer : public Optimizer<TDevice>
    {
...
#endif // OPTIMIZERS_AdamaxOPTIMIZER_HPP
